<script>
  ...
  form_response: {
    answers: [
      ...
      { type: "text", text: formData.business, field: { ref: "business" } },
      ...
      const response = await axios.post('https://api-omega-ochre.vercel.app/leadfromwebsite', formattedData);
        ...
        <div class="w-full md:w-2/3 bg-white rounded-xl shadow-md p-6 sm:p-8">
          ...
          {:else}
            ...
            <form on:submit|preventDefault={handleSubmit} class="space-y-6">
              ...
              <!-- Property Name -->
              <div>
                <label for="business" class="block text-gray-700 font-medium mb-2">Business Name*</label>
                <input 
                  type="text" 
                  id="business" 
