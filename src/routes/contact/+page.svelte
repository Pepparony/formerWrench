...
{#if isOpen}
  <div class="fixed inset-x-0 z-40 bg-yellow500 md:hidden" style="top: 80px;">
    <div class="flex flex-col px-6 py-8 space-y-6">
      ...
      <!-- Mobile CTA Button -->
      <a href="/contact" class="mt-6 rounded-xl w-fit px-8 py-3 bg-white text-yellow-500 text-bold text-xl flex justify-center items-center transition-all duration-100 hover:bg-gray-100" on:click={handleNavClick}>
...
{/if}
    ...
    <section class="w-full flex flex-col py-12 sm:py-16 md:py-20 space-y-8 sm:space-y-10 md:space-y-12 justify-center items-center px-4 sm:px-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-6xl">
        ...
        <div class="bg-white shadow-md rounded-xl p-6 hover:shadow-lg transition-shadow duration-300">
          <div class="rounded-full bg-yellow-500 w-14 h-14 flex items-center justify-center mb-4">
    ...
    <section class="w-full py-12 sm:py-16 md:py-20 bg-gray-50">
      <div class="max-w-6xl mx-auto px-4 sm:px-6">
        <h2 class="text-3xl sm:text-4xl md:text-5xl font-bold text-center mb-8 sm:mb-12">What To <b class="text-yellow-500">Expect</b></h2>
        
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          <!-- Left Column -->
          <div class="flex flex-col space-y-6">
            <div class="flex items-start space-x-4">
              <div class="bg-yellow-500 rounded-full w-8 h-8 flex items-center justify-center flex-shrink-0 mt-1">
          ...
          <div class="flex flex-col space-y-6">
            ...
            <div class="flex items-start space-x-4">
              ...
              <div>
                ...
                <p class="text-gray-700">We continuously refine our approach based on data and feedback to improve results over time.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="space-y-6">
            ...
            <div class="flex items-start space-x-4">
              ...
              <div>
                ...
                <p class="text-gray-700">5804 Fairchase Ave.<br>Charlotte, NC 28269</p>
              </div>
            </div>
          </div>
